...
exports.getIamGrpcClient = getIamGrpcClient;
...
let client;
async function getIamGrpcClient() {
    if (client)
        return client;
    ...
    client = new IAMService(`localhost:${config_1.config.server.port}`, grpc.credentials.createInsecure());
    return client;
}
